      ...
      <div className="formContainer">
        ...
        <div className="wrapper">
          <form onSubmit={handleSubmit}>
            ...
            <div className="item">
              <label htmlFor="school">Nearest School Distance</label>
              <input min={0} id="school" name="school" type="number" />
            </div>
            <div className="item">
              <label htmlFor="bus">Nearest Bus/Metro Station</label>
              <input min={0} id="bus" name="bus" type="number" />
            </div>
            <div className="item">
              <label htmlFor="restaurant">Nearest Restaurant Distance</label>

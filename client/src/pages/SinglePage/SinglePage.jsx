...
//     setSaved((prev) => !prev);
//     console.log(post.id); // Debug: Check if post.id is valid and correct type
...
//     try {
//       // Create or fetch the chat with the post author
//       const response = await apiRequest.post("/chats", {
//         receiverId: post.user.id, // The user who posted the post
//       });
